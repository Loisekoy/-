    ...
    <main className="page profile-page">
      ...
      <form className="profile-form" onSubmit={saveProfile}>
        <div className="form-grid">
          ...
          <label className="field"><span>每次時間</span><select name="training_duration_minutes" defaultValue={profile.training_duration_minutes}>{[30, 45, 60, 90].map((minutes) => <option key={minutes} value={minutes}>{minutes} minutes</option>)}</select></label>
        </div>
